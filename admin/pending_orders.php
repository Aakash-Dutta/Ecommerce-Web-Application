...
<body>
    ...
    <section>
        <div class="container mt-5">
            ...
            <div class="row">
                <?php
                $select_order = "SELECT * FROM orders WHERE payment_status='pending' ORDER BY id DESC";
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <button type="submit" class="btn btn-warning" name="update_payment">Update</button>

                                        <a href="placed_orders.php?delete=<?= $fetch_order['id'] ?>" class="btn btn-danger"
